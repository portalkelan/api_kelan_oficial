...
##  NOME DO ITEM/ANÚNCIO
    url = 'https://kelanapi.azurewebsites.net/oz/name/title'
...
##  PERGUNTA
    url = 'https://kelanapi.azurewebsites.net/oz/message/question'
    response = requests.post(url)
    if response.status_code != 200:
...
## DESCRIÇÃO DO ANÚNCIO 
    url = 'https://kelanapi.azurewebsites.net/oz/items/info'
    response = requests.post(url)
    if response.status_code != 200:
