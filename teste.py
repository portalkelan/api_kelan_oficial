...
openai.api_key = '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'
...
def fetch_and_process_data():
    ...
    try:
        ...
        if question_id in processed_questions:
            ...
            max_tokens = 256
            messages = [
                {"role": "system", "content": f"Atue como um profissional de atendimento ao cliente... [restante da mensagem]"}
            ]
