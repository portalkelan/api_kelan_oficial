...
openai.api_key = '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'  # Sua chave da API OpenAI
...
def insert_into_database(question_id, seller_id, date_created, item_id, question_text, itemName, itemDescription, reply):
    try:
        ...
        if con.is_connected():
            cursor = con.cursor()
            query = "INSERT IGNORE INTO api_decorehome_mlb (question_id, seller_id, date_created, item_id, question_text, itemName, item_Description, response_json) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)"
